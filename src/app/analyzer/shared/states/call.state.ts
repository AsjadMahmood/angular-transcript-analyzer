...
import AgentFacade from 'src/app/analyzer/shared/facades/agent.facade';
import Agent from 'src/app/analyzer/shared/models/agent';

import Call from 'src/app/analyzer/shared/models/call.model';
import Transcript from 'src/app/analyzer/shared/models/transcript.model';
import CallService from 'src/app/analyzer/shared/services/call.service';
